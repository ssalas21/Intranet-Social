...
{
    public partial class SolicitudesFecha : System.Web.UI.Page
    {
        ...
        protected void GvResultadoBusqueda_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string rol = "";
            if (aux2.Rol.Equals("Dideco")) rol = "DIRECTOR DE DESARROLLO COMUNITARIO";
        ...
        protected void BtnExcel_Click(object sender, EventArgs e)
        {
            ...
            GvExcel.DataSource = (new SolicitudesBLL()).ObtenerSolicitudesExcel(CalendarInicio.SelectedDate, CalendarFin.SelectedDate);
            GvExcel.DataBind();
