<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SolicitudesFecha.aspx.cs" Inherits="Dideco.Reportes.SolicitudesFecha" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="PanelResultados" runat="server" Visible="False">
        <fieldset>
            ...
            <asp:ObjectDataSource ID="ODSResultados" runat="server" OldValuesParameterFormatString="{0}" SelectMethod="ObtenerSolicitudesPorFecha" TypeName="Dideco.BLL.SolicitudesBLL">
                <SelectParameters>
