...
{
    public partial class GestionarSecretarias : System.Web.UI.Page
    {
        ...
        protected void BtnAgregarSecretaria_Click(object sender, EventArgs e)
        {
            ...
            {
                LblAgregar.Text = new PersonalBLL().AgregarPersonal(TxtUser.Text.Trim(), TxtPass.Text.Trim(), TxtNombre.Text.Trim(), "Secretaria");
