<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContratosExpirando.aspx.cs" Inherits="Dideco.DirectorAreaOperativa.ContratosExpirando" %>
        ...
        <div class="content-wrapper py-3">
            ...
            <div class="container-fluid">
                ...
                <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" AutoGenerateColumns="False">
                    <Columns>
                        <asp:BoundField DataField="IdContrato" HeaderText="Id Contrato" SortExpression="IdContrato"></asp:BoundField>
                        <asp:BoundField DataField="Nombre" HeaderText="Nombre" SortExpression="Nombre"></asp:BoundField>
                        <asp:BoundField DataField="FechaExpiracion" DataFormatString="{0:d}" HeaderText="Fecha de Expiracion" SortExpression="FechaExpiracion"></asp:BoundField>
                        <asp:BoundField DataField="Monto" HeaderText="Monto" SortExpression="Monto"></asp:BoundField>
                        <asp:BoundField DataField="Gastos" HeaderText="Gastos" SortExpression="Gastos"></asp:BoundField>
                    </Columns>
                </asp:GridView>
                
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ContratosExpirando" TypeName="Dideco.BLL.ContratosOperativaBLL"></asp:ObjectDataSource>
