<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SegurosComplementariosMenu.aspx.cs" Inherits="Dideco.DirectorAreaOperativa.SegurosComplementariosMenu" %>
        ...
        <div class="content-wrapper py-3">
            ...
            <div class="container-fluid">
                ...
                <table style="width: 100%; align-content: center;">
                    <tr>
                            <td align="center">
                                <a href="AgregarSeguroComplementario.aspx" class="myButton">
                                    Agregar Seguro Complementario</a>
                            </td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;</td>
                            <td align="center">
                                <a href="VerSegurosVigentes.aspx" class="myButton">
                                    Ver Seguros Complementarios Vigentes</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td align="center">
                                <a href="SegurosComplementariosVenciendo.aspx" class="myButton">
                                    Seguros Complementarios Venciendo</a>
                            </td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;</td>
                            <td align="center">
                                <a href="Vehiculos.aspx" class="myButton">
                                    Seguros Complementarios Por Vehiculo</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
