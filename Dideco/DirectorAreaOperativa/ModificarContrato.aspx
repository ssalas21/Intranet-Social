<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarContrato.aspx.cs" Inherits="Dideco.DirectorAreaOperativa.ModificarContrato" %>
            ...
            <div class="container-fluid">
                ...
                <br />
                    <asp:Panel ID="PanelContratos" runat="server">
                        <p>Seleccione contrato a modificar</p>
                        <asp:GridView ID="GvContratos" runat="server" AutoGenerateColumns="False" DataKeyNames="IdContrato" DataSourceID="ODSContratos" OnSelectedIndexChanged="GvContratos_SelectedIndexChanged">
                            <Columns>
                                ...
                                <asp:BoundField DataField="Gastos" DataFormatString="${0:N0}" HeaderText="Gastos" SortExpression="Gastos" />
                ...
                <table style="width: 100%; align-content: center;">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <asp:TextBox ID="TxtMontoSuma" runat="server" TextMode="Number" Width="400px"></asp:TextBox></td>
                    </tr>                    
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="BtnModificarContrato" runat="server" Text="Modificar Contrato" OnClick="BtnAgregarContrato_Click" /></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>
