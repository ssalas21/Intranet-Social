<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SegurosComplementariosVenciendo.aspx.cs" Inherits="Dideco.DirectorAreaOperativa.SegurosComplementariosVenciendo" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="content-wrapper py-3">
            ...
            <div class="container-fluid">
                ...
                <asp:GridView ID="GvSeguros" runat="server" DataSourceID="ODSseguro" AutoGenerateColumns="False" DataKeyNames="IdSeguro" OnSelectedIndexChanged="GvSeguros_SelectedIndexChanged">
                    <Columns>
                        <asp:BoundField DataField="IdSeguro" HeaderText="Id del Seguro" SortExpression="IdSeguro"></asp:BoundField>
                ...
                <asp:ObjectDataSource ID="ODSseguro" runat="server" OldValuesParameterFormatString="{0}" SelectMethod="ObtenerSegurosPorVencer" TypeName="Dideco.BLL.SegurosComplementariosBLL"></asp:ObjectDataSource>
