<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerSegurosVigentes.aspx.cs" Inherits="Dideco.DirectorAreaOperativa.VerSegurosVigentes" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="content-wrapper py-3">
            ...
            <div class="container-fluid">
                ...
                <br />
                <br />
                <h2>Seguros Complementarios que aún se encuentran vigentes</h2>
                <br />
                <!-- Icon Cards -->

                <asp:GridView ID="GvSeguros" runat="server" DataSourceID="ODSSeguros" AutoGenerateColumns="False" OnSelectedIndexChanged="GvSeguros_SelectedIndexChanged" DataKeyNames="IdSeguro">
                    <Columns>
                        <asp:BoundField DataField="IdSeguro" HeaderText="Id Seguro" SortExpression="IdSeguro"></asp:BoundField>
                ...
                <asp:ObjectDataSource ID="ODSSeguros" runat="server" OldValuesParameterFormatString="{0}" SelectMethod="ObtenerSegurosVigentes" TypeName="Dideco.BLL.SegurosComplementariosBLL"></asp:ObjectDataSource>
