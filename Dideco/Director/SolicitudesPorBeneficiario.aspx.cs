...
{
    public partial class SolicitudesPorBeneficiario1 : System.Web.UI.Page
    {
        ...
        protected void GvSolicitudesPorRut_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                aprobacion = "LA ASISTENTE AÚN NO EVALUA LA SOLICITUD";
            }
            ...
            {
                Paragraph director = new Paragraph("LA DIRECTORA AÚN NO EVALUA LA SOLICITUD");
                directorTabla.AddCell(director);                
            }            
