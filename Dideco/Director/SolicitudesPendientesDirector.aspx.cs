...
{
    public partial class SolicitudesPendientesDirector1 : System.Web.UI.Page
    {
        ...
        protected void GvSolicitudesDirector_SelectedIndexChanged(object sender, EventArgs e)
        {
            int id = Convert.ToInt32(GvSolicitudesDirector.SelectedValue);
            ...
            TxtVisita.Text = solicitud.Visita;
            ...
            TxtObservacion.Text = solicitud.ObservacionDideco;

        }

        protected void BtnAprobarSolicitud_Click(object sender, EventArgs e)
        {
            (new SolicitudesBLL()).AprobarSolicitudPorDirector(Convert.ToInt32(LblId.Text), TxtObservacion.Text.Trim());
            Solicitudes solicitud = (new SolicitudesBLL()).ObtenerSolicitudPorId(Convert.ToInt32(LblId.Text));
            if ((new AudienciasBLL()).ObtenerAudiencia(Convert.ToInt32(solicitud.IdAudiencia)) != null) {
                try
                {
            ...
            titulo.Add(new Chunk(string.Format("Ficha de ingreso - DIDECO N° {0}", solicitud.IdSolicitud.ToString())).SetUnderline(0, -1));
            ...
            Paragraph asistente2 = new Paragraph(string.Format("LA ASISTENTE SOCIAL : " + BuscarAsistente(solicitud.Asistente) + " EVALUA LA SOLICITUD COMO : " + solicitud.AprobacionAsistente + " EN LA FECHA " + solicitud.FechaAprobacionAsistente.Value.Day + "/" + solicitud.FechaAprobacionAsistente.Value.Month + "/" + solicitud.FechaAprobacionAsistente.Value.Year));
            ...
            Paragraph director = new Paragraph("LA DIRECTORA ESTABLECE QUE LA SOLICITUD ES APROBADA");
        ...
        {
            (new SolicitudesBLL()).RechazarSolicitudPorDirector(Convert.ToInt32(LblId.Text), TxtObservacion.Text.Trim());
            Solicitudes solicitud = (new SolicitudesBLL()).ObtenerSolicitudPorId(Convert.ToInt32(LblId.Text));
            if ((new AudienciasBLL()).ObtenerAudiencia(Convert.ToInt32(solicitud.IdAudiencia)) != null)
            {
                try
            ...
            Paragraph director = new Paragraph("LA DIRECTORA ESTABLECE QUE LA SOLICITUD ES RECHAZADA");
            directorTabla.AddCell(director);
            pdfDoc.Add(directorTabla);
            pdfDoc.Add(new Paragraph(" "));
            pdfDoc.Add(new Paragraph(" "));
        ...
        protected void BtnRecargar_Click(object sender, EventArgs e)
        {
            ...
            GvSolicitudesDirector.DataBind();
        }
    }
}