<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstadisticasRangoEtario.aspx.cs" Inherits="Dideco.DirectorAreaOperativa.EstadisticasRangoEtario1" %>
    ...
    <fieldset>
        ...
        <table border="0">
            <tr>
                ...
                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                <td><asp:DropDownList ID="DdlLocalidades" runat="server" DataTextField="Motivo" DataValueField="IdMotivo" AutoPostBack="True" Width="400px">
            ...
            <tr>                
                ...
                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td> 
                <td>
                    <asp:TextBox ID="TxtFechaInicial" runat="server" TextMode="Date" Width="400px"></asp:TextBox>
                </td>             
            </tr>     
            <tr>
                ...
                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                <td>
                    <asp:TextBox ID="TxtFechaFinal" runat="server" TextMode="Date" Width="400px"></asp:TextBox>
                </td>
            </tr>    
            <tr>
                <td></td>
        ...
        <fieldset>
            ...
            <div style="float: left; width: 300px">
                    <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" DataSourceID="ODSTotales">
                        <Columns>
                            <asp:BoundField DataField="Estado" HeaderText="Rango etario" SortExpression="Estado" />
                            <asp:BoundField DataField="Cantidad" HeaderText="Cantidad" SortExpression="Cantidad" />
                        </Columns>
                    </asp:GridView>
                    <asp:ObjectDataSource ID="ODSTotales" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerEstadisticasEtarioTotales" TypeName="Dideco.BLL.EstadisticasBLL">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="DdlLocalidades" Name="localidad" PropertyName="SelectedValue" Type="String" />
                            <asp:ControlParameter ControlID="TxtFechaInicial" Name="inicio" PropertyName="Text" Type="DateTime" />
                            <asp:ControlParameter ControlID="TxtFechaFinal" Name="final" PropertyName="Text" Type="DateTime" />
        ...
        <fieldset>
            ...
            <fieldset>
                ...
                <div style="float: left; width: 300px">
                    ...
                    <asp:ObjectDataSource ID="ODSAprobados" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerEstadisticasEtarioAprobados" TypeName="Dideco.BLL.EstadisticasBLL">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="DdlLocalidades" Name="localidad" PropertyName="SelectedValue" Type="String" />
                            <asp:ControlParameter ControlID="TxtFechaInicial" Name="inicio" PropertyName="Text" Type="DateTime" />
                            <asp:ControlParameter ControlID="TxtFechaFinal" Name="final" PropertyName="Text" Type="DateTime" />
            ...
            <fieldset>
                ...
                <div style="float: left; width: 300px">
                    ...
                    <asp:ObjectDataSource ID="ODSRechazados" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerEstadisticasEtarioRechazados" TypeName="Dideco.BLL.EstadisticasBLL">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="DdlLocalidades" Name="localidad" PropertyName="SelectedValue" Type="String" />
                            <asp:ControlParameter ControlID="TxtFechaInicial" Name="inicio" PropertyName="Text" Type="DateTime" />
                            <asp:ControlParameter ControlID="TxtFechaFinal" Name="final" PropertyName="Text" Type="DateTime" />
            ...
            <fieldset>
                ...
                <div style="float: left; width: 300px">
                    ...
                    <asp:ObjectDataSource ID="ODSPendientes" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerEstadisticasEtarioPendientes" TypeName="Dideco.BLL.EstadisticasBLL">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="DdlLocalidades" Name="localidad" PropertyName="SelectedValue" Type="String" />
                            <asp:ControlParameter ControlID="TxtFechaInicial" Name="inicio" PropertyName="Text" Type="DateTime" />
                            <asp:ControlParameter ControlID="TxtFechaFinal" Name="final" PropertyName="Text" Type="DateTime" />
