<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Dideco.DirectorAreaOperativa.Index" %>
                        ...
                        <div class="card text-white bg-primary o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">
                                    ...
                                    solicitudes sin aprobar por los asistentes
               
                                </div>
                            </div>
                            <a href="SolicitudesPendientesAsistentes.aspx" class="card-footer text-white clearfix small z-1">
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-warning o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5">
                                    <asp:Label ID="LblCantidadDirector" runat="server" Text="Label"></asp:Label>
                                    solicitudes sin aprobar por el director
               
                                </div>
                            </div>
                            <a href="SolicitudesPendientesDirector.aspx" class="card-footer text-white clearfix small z-1">
                                <span class="float-left">Ver Detalles</span>
                                <span class="float-right">
                                    <i class="fa fa-angle-right"></i>
                                </span>
