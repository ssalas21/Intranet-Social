<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolicitudesAlcaldia.aspx.cs" Inherits="Dideco.DirectorAreaOperativa.SolicitudesAlcaldia" %>
                    ...
                    <fieldset>
                        ...
                        <table border="0" style="margin-top: 20px">
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <asp:Button ID="BtnDerivar" runat="server" Text="Derivar" Visible="false" OnClick="BtnDerivar_Click" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td class="text-left">
                                    <asp:CheckBox ID="ChkVivienda" runat="server" Text="Vivienda" Visible="False" />
                                    <br />
                                    <asp:CheckBox ID="ChkAlimentacion" runat="server" Text="Alimentación" Visible="False" />
                                    <br />
                                    <asp:CheckBox ID="ChkSalud" runat="server" Text="Salud" Visible="False" />
                                    <br />
                                    <asp:CheckBox ID="ChkInfancia" runat="server" Text="Infancia" Visible="False" />
                                    <br />
                                    <asp:CheckBox ID="ChkDefunciones" runat="server" Text="Defunciones" Visible="False" />
                                    <br />
                                    <asp:CheckBox ID="ChkMicroemprendimiento" runat="server" Text="Microemprendimiento" Visible="False" />
                                    <br />
                                    <asp:CheckBox ID="ChkPSGubernamental" runat="server" Text="Prog. Soc. Gubernamental" Visible="False" />
                                    <br />
                                    <asp:CheckBox ID="ChkMaquinaria" runat="server" Text="Maquinaria" Visible="False" />
                                    <br />
                                    <asp:CheckBox ID="ChkPersonalMunicipal" runat="server" Text="Personal Municipal" Visible="False" />
                                    <br />
                                    <asp:CheckBox ID="ChkRebajaAseo" runat="server" Text="Rebaja Aseo" Visible="False" />
                                    <br />
                                    <asp:CheckBox ID="ChkAgua" runat="server" Text="Entrega de Agua" Visible="False" />
                                    <br />
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="LblRSH" runat="server" Text="¿Pertenece al registro social de hogares? " Visible="False"></asp:Label>
                                </td>
                                <td></td>
                                <td>
                                    <asp:RadioButton ID="RbRegistroSocialTrue" runat="server" Text="Si" GroupName="RegistroSocial" OnCheckedChanged="RbRegistroSocialTrue_CheckedChanged" AutoPostBack="True" Visible="False" /><asp:RadioButton ID="RbRegistroSocialFalse" runat="server" Checked="True" Text="No" GroupName="RegistroSocial" OnCheckedChanged="RbRegistroSocialFalse_CheckedChanged" AutoPostBack="True" Visible="False" /></td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="LblPorcentaje" runat="server" Text="¿Cual es su porcentaje?" Visible="False"></asp:Label></td>
                                <td></td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label1" runat="server" Text="Seleccionar asistente social al cual asignar el caso" Visible="False"></asp:Label>
                                </td>
                                <td></td>
                                <td>
                                    <asp:DropDownList ID="DdlAsistente" runat="server" DataSourceID="ODSAsistentes" DataTextField="Nombre" DataValueField="User" Height="30px" Width="240px" Visible="False"></asp:DropDownList>
                            ...
                            <tr>
                                <td></td>
                                <td>
                                    <asp:Button ID="BtnAgregarSolicitud" runat="server" Text="Agregar Solicitud" CssClass="btn-primary" OnClick="BtnAgregarSolicitud_Click" Visible="false" /></td>
                                <td></td>
                            </tr>
                        </table>
                    </fieldset>
