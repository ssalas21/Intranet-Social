<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolicitudesPendientesAsistentes.aspx.cs" Inherits="Dideco.DirectorAreaOperativa.SolicitudesPendientesAsistentes1" %>
        ...
        <fieldset>
            ...
            <asp:GridView ID="GvSolicitudesPendientes" runat="server" AutoGenerateColumns="False" DataSourceID="ODSSolicitudes" CssClass="bg-info" OnSelectedIndexChanged="GvSolicitudesPendientes_SelectedIndexChanged" AllowPaging="True" CellPadding="2" CellSpacing="2" DataKeyNames="IdSolicitud">
                <Columns>
                    ...
                    <asp:CommandField ShowSelectButton="True" ButtonType="Image" HeaderText="Revisar Solicitud" SelectImageUrl="~/img/elegir.png" />
                </Columns>
            </asp:GridView>
            <asp:ObjectDataSource ID="ODSSolicitudes" runat="server" OldValuesParameterFormatString="{0}" SelectMethod="SolicitudesDirectorSinAprobarPorAsistente" TypeName="Dideco.BLL.SolicitudesBLL">
        ...
        <fieldset>
            ...
            <table border="0" style="margin-top: 20px">
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:DropDownList ID="DdlVisita" runat="server" Width="340" AutoPostBack="True" OnSelectedIndexChanged="DdlVisita_SelectedIndexChanged">
